...
def delete_forecast_files(year, month, day, lead_time_weeks, RAW_S2S_DATA_DIR, PROC_S2S_DATA_DIR, REG_MEAN_DATA_DIR, shapefile_name):
    """Delete forecast files for a given date and lead times.
    args:        year, month, day: date of forecast initialization
        lead_time_weeks: list of lead weeks to delete, e.g. [1, 2, 3]
